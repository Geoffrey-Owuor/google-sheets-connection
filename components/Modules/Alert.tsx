...
const Alert = ({ message, type, onClose }: AlertProps) => {
  ...
  return (
    ...
    >
      <div
        className={`mt-4 flex w-auto min-w-[300px] items-center justify-between rounded-xl bg-black px-3 py-4.5 text-white shadow-md dark:bg-white dark:text-black`}
      >
