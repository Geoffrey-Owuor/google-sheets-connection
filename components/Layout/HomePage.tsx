        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="mx-auto w-full max-w-3xl rounded-xl bg-slate-200 p-6 dark:bg-slate-800/50">
            <p className="text-left">
              ...
              lightweight, surprisingly powerful mini-CMS. Instead of spinning
              up a full database or wrestling with a heavy-duty CMS, it simply
              taps into the Google Sheets API and pulls content straight from a
              spreadsheet in real time. That means your content editors
              don&apos;t need to learn any new tools - if they can edit a
              spreadsheet, they can shape the entire app. Update a cell, tweak a
              value, hit save... and the application instantly reflects those
              changes. No code edits, no deployments, no stress. It&apos;s a
              simple, flexible, and delightfully efficient setup - turning an
            ...
            <ul className="list-disc space-y-2 pl-5 italic marker:text-blue-500 dark:marker:text-blue-300">
              ...
              <li>Working on updating existing data</li>
            </ul>
          </div>
